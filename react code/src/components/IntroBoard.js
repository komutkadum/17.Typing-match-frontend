    ...
    return (
        <div>
            <div className="w3-container w3-teal">
                ...
                <h1>
                    <p className='w3-dropdown-hover w3-left'>
                        <i className='fas fa-caret-square-left w3-animate-zoom w3-margin-right'></i>
                        <span style={{right:"0",fontWeight:'bold'}} className="w3-dropdown-content w3-large w3-teal w3-border w3-padding w3-round">
                            <ul className='w3-ul w3-border-0'>
                                <li>A peer to peer typing competition</li>
                                <li>where users can compete with their</li>
                                <li>friends and be the typing champion</li>
                                <li>among them. </li>
                            </ul>
                        </span>
                    </p>
                    Welcome to Typing P2P 
                    <p className='w3-dropdown-hover'>
                        <i className='fas fa-caret-square-right w3-margin-left w3-animate-zoom'></i>
                        <span className="w3-dropdown-content w3-large w3-white w3-border w3-round w3-">
                            <ul className='w3-ul' style={{textAlign:"left"}}>
                                <li className='w3-red'>Use chrome or Microsoft edge for better performance.</li>
                                <li className='w3-center w3-teal'>How to Use</li>
                                <li className='w3-light-grey'>1. Enter username and join server.</li>
                                <li className='w3-light-grey'>2. Enter gameid shared by another user.</li>
                                <li className='w3-light-grey'>3. Or Create gameid and share it to your friend.</li>
                            </ul>
                        </span>
                    </p>
